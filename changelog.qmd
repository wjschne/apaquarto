...
# Version 6.0.0
- 2026-09-12
- `numbered-lines` numbers the lines in apaquarto-latex-pdf and in apaquarto-typst, in every document mode. The typst numbers are set in DejaVu Sans Mono, which is the one sans face typst bundles. It is possible to name a different font for the line numbers via the `linenumber-font` option (credit to Claude).
