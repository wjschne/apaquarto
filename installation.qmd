...
1. Select *Session &rarr; Set Working Directory &rarr; Choose Working Directory*

![Set Working Directory Via RStudio Menu](menuworkingdirectory.png)
...
The apaquarto source code is in [this repository](https://github.com/wjschne/apaquarto). Installing the extension will install the contents of the `_extensions/apaquarto` folder. If you install the template, it will install the `template.qmd` file and rename it to the name of the folder you install the template to. In addition these files will the installed
...
![RStudio terminal. It is okay if your console looks different from mine.](terminal.png){#fig-terminal}
