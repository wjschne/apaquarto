...
# yml <- get_metadata("1author2affilations2unnamed.qmd")$author
...
title_display <- function(title, subtitle) {
...
display_title <- title_display(yml_metadata$title , yml_metadata$subtitle)
