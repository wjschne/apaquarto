...
I have set two of my publications to be masked. If you set `mask: true` in the yaml metadata, they will appear masked. In previous studies, things were asserted  [@schneider2015intelligence]. @schneider2012cattell made additional points.
