...
#| fig-width: 3
#| out-width: 48%
knitr::include_graphics("https://wjschne.github.io/apaquarto/img/sampleimage.png")
```

Figure graphics can be imported directly with Markdown:

![Another Way to Import Graphics](https://wjschne.github.io/apaquarto/img/sampleimage.png){#fig-import2 apa-note="A note below the figure" width="49%"}
...
![Appendix Figure](https://wjschne.github.io/apaquarto/img/sampleimage.png){#fig-appendfig apa-note="A note below the figure"}
