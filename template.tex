...
document? No problem. Just put them all at the end, in order. The
reference labels will work no matter where they are in the text.

If you are rendering to pdf, you can place your figures and tables at
the end by setting the \texttt{floatsintext} option to \texttt{false}.
