...
All of the .pdf-specific options for apaquarto come directly from the [apa7 $\LaTeX$ package](https://ctan.org/pkg/apa7?lang=en). Consult the apa7 package documentation for greater detail.
