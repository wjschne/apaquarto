...
Options are set in the YAML metadata section at the top of the .qmd file.

t uses [YAML](https://yaml.org/), a format that allows us to store data in a format that is easy to write and easy to read. In its simplest form, it has a key and a value:
