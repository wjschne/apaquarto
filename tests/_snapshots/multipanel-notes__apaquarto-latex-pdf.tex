...
/makeatother
/setapashorttitle{MULTIPANEL NOTES}
/usepackage{bookmark}
...
See Figure~/ref{fig-panels}, Figure~/ref{fig-second} and
Table~/ref{tbl-values}.
...
/apafloatcaption{Values by group.}
...
Text after the float, so that the spacing which follows a figure with a
note has something to apply to
