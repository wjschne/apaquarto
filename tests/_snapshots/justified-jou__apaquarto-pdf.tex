...
several lines, because a paragraph of one line is justified and ragged
alike and would show nothing at all. It runs on for a while so that the
lines in between the first and the last have to be set one way or the
...
/apafloatcaption{Scale types.}

{/def/LTcaptype{none} % do not increment counter
/begin{longtable}[]{@{}
  >{/raggedright/arraybackslash}p{(/linewidth - 2/tabcolsep) * /real{0.3500}}
  >{/raggedright/arraybackslash}p{(/linewidth - 2/tabcolsep) * /real{0.6500}}@{}}
/toprule/noalign{}
...
/bottomrule/noalign{}
/endlastfoot
Ratio & A scale with a true zero, where it is meaningful to say that one
value is twice another. //
