...
/
/
#heading(level: 1, outlined: false, numbering: none)[Author With an ORCID]
<title>
#set align(center)
#block[
/
...
#v(apafirstparshift)
Test Author #box(image("_extensions/apaquarto/ORCID-iD_icon-vector.svg", alt: "Orcid ID Logo: A green circle with white letters ID", width: 4.23mm)) #link("https://orcid.org/0000-0002-1825-0097")
...
<abstract>
#block[
An author note carrying an orcid.

]
#pagebreak()

#heading(level: 1, numbering: none)[Author With an ORCID]
<firstheader>
= Method
<method>
#[#set par.line(numbering: none)
