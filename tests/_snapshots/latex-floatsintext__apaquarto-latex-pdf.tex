...
/makeatother
/setapashorttitle{FLOATS AT END}
/usepackage{bookmark}
...
Exercises floatsintext in the plain LaTeX format.
...
Text of the body, which must come before the floats. See
Figure~/ref{fig-end} and Table~/ref{tbl-end}.
