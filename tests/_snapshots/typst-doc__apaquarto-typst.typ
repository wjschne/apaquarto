...
#apadocabstractgap()
#set footnote.entry(separator: docauthornoterule)
#apadocauthornote[
#[#set par.line(numbering: none)
#par()[#text(size:0.5em)[#h(0.0em)]]]
#v(apafirstparshift)
Correspondence concerning this article should be addressed to Dana Doc, Example University, Email: #link("mailto:dana@example.edu")[dana/@example.edu]
...
position: top,
[
A table that should appear inline in document mode.
]),
