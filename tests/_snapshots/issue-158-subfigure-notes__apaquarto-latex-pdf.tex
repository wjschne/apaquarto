...
Subfigure Figure-Note Reproducer
...
/emph{Note}. This~note belongs to a single, non-subfigure figure.
...
/emph{Note}. Note~for the first panel.
...
/emph{Note}. Note~for the second panel.
...
/apafloatcaption{An overall caption for the whole figure.}
...
/apafloatcaption{An overall caption for the mixed figure.}

/apafigureskip

/begin{apapanel}{0.4900}%
/textbf{Panel A}. Panel without a note.
...
/hfill
/begin{apapanel}{0.4900}%
/textbf{Panel B}. Panel with a note.
...
/emph{Note}. Only~this panel has a note.
...
/emph{Note}. This~note belongs to the table.
