...
/makeatother
/setapashorttitle{SPANNING FLOATS}
/singlespacing
/apatwocolumn
...
Floats Spanning Both Columns in Plain LaTeX
...
Exercises apa-twocolumn on figures and tables in plain LaTeX journal
mode.
...
See Figure~/ref{fig-wideimage}, Figure~/ref{fig-widechunk},
Figure~/ref{fig-narrow} and Table~/ref{tbl-widechunk}.
...
/apafloatcaption{A wide figure written as a markdown image.}
...
/emph{Note}. A~note on the wide image.
...
/apafloatcaption{A wide figure written as a code chunk.}

/apafigureskip

/pandocbounded{/includegraphics[keepaspectratio,alt={A line.}]{latex-jou-floats_files/figure-pdf/fig-widechunk-1.png}}

/begin{apafloatnote}

/emph{Note}. A~note on the wide chunk.
...
/apafloatcaption{A narrow figure written as a code chunk.}

/apafigureskip

/pandocbounded{/includegraphics[keepaspectratio,alt={Another line.}]{latex-jou-floats_files/figure-pdf/fig-narrow-1.png}}

/end{figure}

/begin{apafloatnote}

/emph{Note}. A~note on the narrow chunk.
...
/apafloatcaption{A wide table written as a code chunk.}
...
/emph{Note}. A~note on the wide table.
