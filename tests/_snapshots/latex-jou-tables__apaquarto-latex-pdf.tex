...
/documentclass[
  ...
  twoside]{article}
/usepackage{xcolor}
/usepackage[margin=0.75in,includehead,headheight=13pt,headsep=4pt]{geometry}
...
/makeatother
/setapashorttitle{JOURNAL TABLES}
/singlespacing
/apatwocolumn
...
/begin{lrbox}{/apamastheadbox}%

/begin{minipage}{/textwidth}

/apajoutitle{

Tables and Appendix References in Plain LaTeX
...
Exercises table numbering, appendix references and longtable head and
foot handling.
...
/twocolumn[/apamastheadlift/usebox{/apamastheadbox}]
...
See Table~/ref{tbl-md}, Table~/ref{tbl-chunk}, Table~/ref{tbl-apx} and
Figure~/ref{fig-apx}.
...
/apafloatcaption{A markdown table.}
...
/emph{Note}. A~note on the markdown table.
...
/apafloattitle{Table 2}

/apafloatcaption{A table written as a code chunk.}
...
/emph{Note}. A~note on the chunk table.
...
/section{An Appendix}/label{apx-a}

/setlength{/parindent}{1em}

Text in the appendix, which refers to Table~/ref{tbl-apx} and to
Figure~/ref{fig-apx}.
...
/refstepcounter{table}%
/makeatletter/def/@currentlabel{A1}/makeatother%
/label{tbl-apx}

/apafloattitle{Table A1}

/apafloatcaption{A table in an appendix.}
...
/emph{Note}. A~note on the appendix table.
...
/apafloattitle{Figure A1}

/apafloatcaption{A figure in an appendix.}
...
/emph{Note}. A~note on the appendix figure.
