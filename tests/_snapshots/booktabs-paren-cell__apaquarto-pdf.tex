...
/makeatother
/setapashorttitle{BOOKTABS TRIM ARGUMENT}
/usepackage{bookmark}
...
A Table Cell That Opens With a Parenthesis
...
/apafloatcaption{Written by pandoc, so every rule is followed by a
noalign}
...
/apafloatcaption{Written as latex, in a tabular}
...
/apafloattitle{Table 3}

/apafloatcaption{Written as latex, in a longtable: the case that
crashed}
