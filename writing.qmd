...
![Create new Quarto docuemnt from the RStudio men](newquartodocument.png){#fig-newquarto}
...
If there are multiple appendices, begin each with level-1 headers, called `Appendix A`, `Appendix B`, `Appendix C`, and so forth.
