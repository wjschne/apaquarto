...
If you want to cite an entire appendix in your text, give the appendix a section identifier with a `sec-` prefix like so:
...
Whatever word specified in this manner will act as the Appendix header:
